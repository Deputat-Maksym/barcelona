        ...
        function get_car_price() {
            ...
            if(active_selecet_1 == "Барселона" && active_selecet_2 == "Ситджес") {
            ...
            } else if(active_selecet_1 == "Барселона" && active_selecet_2 == "Вианова") {
                ...
                var price_arr = ["95"+sumbol, "110"+sumbol, "130"+sumbol];

            } else if(active_selecet_1 == "Барселона" && active_selecet_2 == "Калафель") {

                var price_arr = ["95"+sumbol, "105"+sumbol, "130"+sumbol];

            } else if(active_selecet_1 == "Барселона" && active_selecet_2 == "Торредембарра") {

                var price_arr = ["110"+sumbol, "120"+sumbol, "130"+sumbol];

            } else if(active_selecet_1 == "Барселона" && active_selecet_2 == "Салоу") {

                var price_arr = ["120"+sumbol, "150"+sumbol, "170"+sumbol];

            } else if(active_selecet_1 == "Барселона" && active_selecet_2 == "Камбрильс") {

                var price_arr = ["125"+sumbol, "150"+sumbol, "170"+sumbol];

            } else if(active_selecet_1 == "Барселона" && active_selecet_2 == "Порт Авентура") {

                var price_arr = ["125"+sumbol, "145"+sumbol, "170"+sumbol];

            } else if(active_selecet_1 == "Барселона" && active_selecet_2 == "Cruise Port") {
            ...
            } else if(active_selecet_1 == "Барселона" && active_selecet_2 == "Тарраса") {
            ...
            } else if(active_selecet_1 == "Барселона" && active_selecet_2 == "La Roca Village") {
            ...
            }else if(active_selecet_1 == "Ситджес" && active_selecet_2 == "Барселона") {

                var price_arr = ["74"+sumbol, "95"+sumbol, "115"+sumbol];

            } else if(active_selecet_1 == "Вианова" && active_selecet_2 == "Барселона") {
            ...
            } else if(active_selecet_1 == "Cruise Port" && active_selecet_2 == "Барселона") {
            ...
            } else if(active_selecet_1 == "Тарраса" && active_selecet_2 == "Барселона") {
            ...
            } else if(active_selecet_1 == "La Roca Village" && active_selecet_2 == "Барселона") {
            ...
            } else if(active_selecet_1 == "Аэропорт Эль Прат" && active_selecet_2 == "Вианова") {
            ...
            } else if(active_selecet_1 == "Аэропорт Эль Прат" && active_selecet_2 == "Тарраса") {
            ...
            } else if(active_selecet_1 == "Аэропорт Эль Прат" && active_selecet_2 == "La Roca Village") {
                ...
                var price_arr = ["95"+sumbol, "115"+sumbol, "130"+sumbol];
                ...
                var price_arr = ["105"+sumbol, "120"+sumbol, "140"+sumbol];

            } else if(active_selecet_1 == "Аэропорт Эль Прат" && active_selecet_2 == "Тосса-де-Мар") {

                var price_arr = ["120"+sumbol, "140"+sumbol, "155"+sumbol];
            ...
            } else if(active_selecet_1 == "Вианова" && active_selecet_2 == "Аэропорт Эль Прат") {
            ...
            } else if(active_selecet_1 == "Тарраса" && active_selecet_2 == "Аэропорт Эль Прат") {
            ...
            } else if(active_selecet_1 == "La Roca Village" && active_selecet_2 == "Аэропорт Эль Прат") {
