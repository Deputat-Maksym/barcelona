                ...
                <form action="">
                    <div class="bef1" data-from="откуда">
                        <select name="" id="first_select">
                            ...
                            <option value="3">Круизный Порт</option>
                            <option value="4">Салоу</option>
                            <option value="5">Льорет-де-Мар</option>
                            <option value="6">Калелья</option>
                            <option value="7">Порт Авентура</option>
                            <option value="8">Торредембарра</option>
                            <option value="9">Виланова</option>
                            <option value="10">Камбрильс</option>
                            <option value="11">Калафель</option>
                            <option value="12">Ситжес</option>
                            <option value="13">Бадалона</option>
                            <option value="14">Монкада-и-Решак</option>
                            <option value="15">Террасса</option>
                            <option value="16">Матаро</option>
                            <option value="17">Ла Рока Виладж</option>
                            <option value="18">Кома-Руга</option>
                            <option value="19">Мальграт-де-Мар</option>
                            <option value="20">Санта-Сусанна</option>
                            <option value="21">Кунит</option>
